package topic_02_JavaFX_Events.eventHandlingSyntax;
...
public class EventHandlingDemoMVC extends Application {
	...
	/**
	 * Optional. An opportunity to clean house, for example, disconnecting from a
	 * database or network server, before the program ends.
	 */
	@Override
	public void stop() {
		if (view != null)
