...
/**
 * Diese Klasse möchte sicherstellen das es NUR EIN Objekt der Klasse gibt.
 * Dazu brauchen wir eine Factory Methode, weil wir eben die Erstellung von
 * neuen Objekten steuern wollen.
 */
...
public class WoofSingleton {
	...
	/**
	 * Factory Methode, um das Design Pattern Singleton zu veranschaulichen
	 * Möchten nur 1 Objekt erlauben
	 * 
	 */
	public static WoofSingleton makeWoof() {
		...
		// Retourniere das Objekt (Falls bereits eines vorhanden ist, wird die IF Bedingung
