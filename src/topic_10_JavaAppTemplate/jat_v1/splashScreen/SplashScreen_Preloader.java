...
public class SplashScreen_Preloader extends Preloader {
	 ...
	 * 
	 * @param info Details can be passed in the parameter; the parameter implements
	 *             the PreloaderNotification interface. The application must create
	 *             a class containing the information it needs
	 */
	@Override
	...
	/**
	 * Respond to standard state changes of the main program. Typically, a splash
	 * screen will hide itself when the main application starts
	 * 
	 ...
	 * @return true if the error has been displayed; false if Java needs to display
	...
	/**
	 * This class implements the PreloaderNotification interface, which is used to
	 * pass application-notifications to the splash screen
	 */
