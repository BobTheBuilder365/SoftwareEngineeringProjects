...
import topic_10_JavaAppTemplate.jat_v1.JavaFX_App_Template;
import topic_10_JavaAppTemplate.jat_v1.abstractClasses.Controller;
...
public class Splash_Controller extends Controller<Splash_Model, Splash_View> {
	...
	public Splash_Controller(final JavaFX_App_Template main, Splash_Model model, Splash_View view) {
		...
		// However, JavaFX can also do this for us: We just bind the progressProperty of
		// the
