...
public class ExamplesView {
	...
	public ExamplesView(Stage stage, ExamplesModel model) {
		...
		txtStack.setDisable(true); txtStack.setVisible(false); // No user input needed
		...
		txtArrayIndex.setDisable(true); txtArrayIndex.setVisible(false); // No user input needed
		root.getChildren().add(hbox);
		...
		scene.getStylesheets().add(
				getClass().getResource("Examples.css").toExternalForm());
