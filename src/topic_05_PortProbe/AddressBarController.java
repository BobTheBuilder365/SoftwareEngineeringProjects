...
/**
 * The AddressBarController takes the WebValidator example, and puts it into an
 * HBox. This way, we can re-use our code in any number of programs.
 * 
 * We do not process click of our button, since the address-bar doesn't know
 * what to do with them. That is the job of the main controller.
 */
public class AddressBarController {
	...
	public AddressBarController(AddressBarView view) {
		this.view = view;
