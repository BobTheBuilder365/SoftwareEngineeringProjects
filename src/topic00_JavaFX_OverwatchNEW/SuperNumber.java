package topic00_JavaFX_OverwatchNEW;
...
public class SuperNumber {
	...
	private void updateRepresentations() {
		asDecimal.set(valueSN.toString());
		asBinary.set(Integer.toBinaryString(valueSN));
		asHexadecimal.set(Integer.toHexString(valueSN));
	...
	public void setAsDecimal(String newValue) {
		valueSN = Integer.parseInt(newValue);
		updateRepresentations();
	}
	...
	public void setAsBinary(String newValue) {
		valueSN = Integer.parseInt(newValue, 2);
		updateRepresentations();
	}
	...
	public void setAsHexadecimal(String newValue) {
		valueSN = Integer.parseInt(newValue, 16);
		updateRepresentations();
	}
}
